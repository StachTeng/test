...
class Tieba:  # 爬取每一页的贴吧帖子信息
    ...
    def scratch(self):
        tieziliebiao = soup.findAll('div'{})
        if 'class'=="bbs-content":
            print(tieziliebiao)
...
if __name__ == "__main__":
    ...
    for i in range(0, 50):
        url="https://movie.douban.com/subject/1292052/comments?start="+str(20*(i-1))+"&limit=20&status=P&sort=new_score"
    ...
    url = "http://bbs.tianya.cn/post-university-1197708-1.shtml"
