...
class Tieba:  # 爬取每一页的贴吧帖子信息
    ...
    def scratch(self):
        # tieziliebiao = soup.findAll('div', {'class': 'main-bd'})
        # print(tieziliebiao)
        neirong = soup.findAll('div', {'class': 'short-content'}).text
        print(neirong)
        Tiezi = [neirong]
        Tiezi_list.append(Tiezi)

        # for each in tieziliebiao.findAll('div'):
        #
        #     try:
        #         name = each.find('class' == 'review-short ').text  # 帖子的主题
        #         print('haha1')
        #         content = each.find('class' == 'short-content').text  # 帖子的内容
        #         print('haha2')
...
if __name__ == "__main__":
    ...
    url = "https://movie.douban.com/subject/1292052/reviews?start="
