...
#---**-------**-------**-------**-------**-------**-------**-------**-------**-------**-------**-------**-------**----
    ...
    #利用代理IP爬取豆瓣电影评论
    url1 = "https://movie.douban.com/subject/1292052/comments?start="
    ...
    workbook = xlsxwriter.Workbook('豆瓣电影评论.xlsx')  # 将爬取的信息存入 '豆瓣电影评论.xlsx'                                              #创建Excel文件
    worksheet = workbook.add_worksheet()
